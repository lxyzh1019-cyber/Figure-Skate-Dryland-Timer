# WORKING RECORD — Figure-Skate-Dryland-Timer (Skate with Grace) — rules v2
...
| 2 | R1 2026-09-24 | Left panel hide asks for password on swim, not on skate (reported against swim; same code here) | done | `toggleRail` missing from `UNGATED_ACTIONS`; same code in skate, skate difference unverified (likely a live 5-min unlock) |
