# FEATURES — Skate with Grace (Figure Skate Dryland Timer) — manifest v1 (partial) — confirmed 2026-09-24
...
- `core/` is byte-identical with the Swimming-Dryland-Timer repo.
