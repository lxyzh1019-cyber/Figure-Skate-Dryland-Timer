...
function promptCard(vm, size) {
  ...
  if (vm.phase === "landing") {
    return `
    <div style="width:${size}px;min-height:${Math.round(size * 0.8)}px;border-radius:26px;background:var(--grape-wash);border:3px solid var(--grape);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:22px;box-sizing:border-box;flex-shrink:0;">
      <div style="font-size:34px;line-height:1;">🧊</div>
      <div style="font-family:var(--font-display);font-weight:600;font-size:22px;color:var(--ink);text-align:center;">Landing check</div>
      <div style="font-size:14px;font-weight:700;color:var(--ink-soft);text-align:center;">${vm.curExName ? vm.curExName + " — " : ""}how did those landings freeze?</div>
      <div style="display:flex;flex-direction:column;gap:8px;width:100%;">
        <button type="button" data-action="gradeLanding" data-arg="clean" style="min-height:52px;border-radius:16px;border:3px solid var(--mint);background:var(--mint-wash);color:var(--mint-ink);font-weight:900;font-size:16px;cursor:pointer;font-family:inherit;">🧊 Clean &amp; frozen</button>
        <button type="button" data-action="gradeLanding" data-arg="wobbly" style="min-height:52px;border-radius:16px;border:3px solid var(--sun);background:var(--sun-wash);color:var(--sun-ink);font-weight:900;font-size:16px;cursor:pointer;font-family:inherit;">〰️ A bit wobbly</button>
      </div>
      <div style="font-size:12px;font-weight:700;color:var(--ink-faint);text-align:center;">2 wobbly in a row = we drop a round. Quality over quantity.</div>
    </div>`;
  }
  if (vm.phase === "microloop") {
    ...
    <div style="width:${size}px;min-height:${Math.round(size * 0.8)}px;border-radius:26px;background:var(--aqua-wash);border:3px solid var(--aqua);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:22px;box-sizing:border-box;flex-shrink:0;">
      <img src="assets/skate/illo-focus.png" alt="" style="height:70px;object-fit:contain;">
  ...
  <div style="width:${size}px;min-height:${Math.round(size * 0.8)}px;border-radius:26px;background:var(--mint-wash);border:3px solid var(--mint);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:22px;box-sizing:border-box;flex-shrink:0;">
    <img src="assets/skate/illo-take-a-breath.png" alt="" style="height:90px;object-fit:contain;">
...
function stopOverlay() {
  ...
  <div style="position:absolute;inset:0;z-index:20;background:var(--stop-wash);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:40px;text-align:center;">
    <img src="assets/skate/illo-take-a-breath.png" alt="" style="height:180px;object-fit:contain;">
    ...
    <div data-stop-propagation="1" style="background:var(--surface);border-radius:var(--radius-xl);box-shadow:var(--shadow-pop);max-width:680px;width:100%;max-height:100%;overflow-y:auto;box-sizing:border-box;">
      ...
      <div style="padding:22px 26px 26px;display:flex;flex-direction:column;gap:14px;">
        ...
        <div style="background:var(--sea-wash);border-radius:var(--radius-md);padding:12px 14px;">
          <div style="font-size:11px;font-weight:900;letter-spacing:0.06em;text-transform:uppercase;color:var(--sea-ink);margin-bottom:4px;">⛸️ On-ice transfer</div>
          <div style="font-size:15px;font-weight:700;color:var(--ink);line-height:1.4;">${vm.detailSkate}</div>
        </div>` : ""}
      </div>
    </div>
  </div>`;
...
function completeScreen(vm) {
  ...
  <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;gap:16px;padding:40px;text-align:center;background:${vm.endedEarly ? "var(--sun-wash)" : "var(--mint-wash)"};overflow-y:auto;">
    <img src="assets/skate/${vm.endedEarly ? "illo-nice-work" : "illo-way-to-go"}.png" alt="" style="height:${vm.endedEarly ? 170 : 230}px;object-fit:contain;flex-shrink:0;">
    <div style="font-family:var(--font-display);font-weight:600;font-size:34px;color:${vm.endedEarly ? "var(--sun-ink)" : "var(--mint-ink)"};">${vm.endedEarly ? "Stopped early — progress saved." : "Session Complete!"}</div>
    ...
    <div style="display:flex;flex-direction:column;align-items:center;gap:10px;margin-top:6px;">
      <div style="display:flex;align-items:center;gap:10px;">
        <img src="assets/skate/illo-focus.png" alt="" style="height:64px;object-fit:contain;">
    ...
    <div style="display:flex;flex-direction:column;gap:12px;background:var(--surface);border-radius:20px;padding:18px 22px;box-shadow:var(--shadow-soft);max-width:600px;width:100%;box-sizing:border-box;text-align:left;">
      <div style="display:flex;align-items:center;gap:10px;">
        <img src="assets/skate/hero-home.png" style="width:44px;height:44px;object-fit:contain;flex-shrink:0;" alt="">
        <div>
          <div style="font-family:var(--font-display);font-weight:600;font-size:18px;color:var(--ink);">Coach's Quiz 🧠</div>
          <div style="font-size:12px;font-weight:800;color:var(--ink-soft);">How does today's work help you skate?</div>
        </div>
      </div>
...
function centerStack(vm, wide) {
  ...
  <div style="display:flex;align-items:center;gap:10px;background:var(--sun-wash);border-radius:var(--radius-lg);padding:10px 14px;box-sizing:border-box;width:100%;max-width:480px;flex-shrink:0;">
    <img src="assets/skate/illo-take-a-breath.png" style="width:64px;height:58px;object-fit:contain;flex-shrink:0;" alt="">
...
function controls(vm, wide) {
  ...
  <div style="display:flex;${wide ? "align-items:center;gap:14px;" : "flex-direction:column;gap:8px;"}background:var(--surface-2);border-radius:var(--radius-md);padding:10px 14px;">
    ${wide ? `<img src="assets/skate/illo-nice-work.png" alt="" style="height:52px;object-fit:contain;flex-shrink:0;">` : ""}
...
function tipsSafety(vm) {
  ...
  <div style="flex-shrink:0;background:var(--surface);border:1.5px solid var(--hairline);border-radius:var(--radius-lg);box-shadow:var(--shadow-soft);box-sizing:border-box;padding:14px 16px;display:flex;flex-direction:column;gap:10px;">
    ...
    <div style="background:var(--aqua-wash);border-radius:var(--radius-md);padding:12px 14px;box-sizing:border-box;display:flex;align-items:center;gap:12px;">
      <img src="assets/skate/illo-keep-going.png" alt="" style="width:68px;height:52px;object-fit:contain;flex-shrink:0;">
    ...
    ${vm.curExSkate && vm.notResting ? `<div style="background:var(--sea-wash);border-radius:var(--radius-md);padding:10px 14px;font-size:14px;font-weight:700;color:var(--sea-ink);">⛸️ Builds: ${vm.curExSkate}</div>` : ""}
