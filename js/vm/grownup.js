/* ============================================================
   ...
   (skate_sessions_v2, skate_events_v1, skate_quiz_v1, trackers);
...
import { settings, loadSessions, loadEvents, loadQuiz, loadGate, loadLadderRungs, loadTracker, getCurrentTrackerWeek, activeEngagement, activePrizePool, quizBankStatus, quizPaidToday } from "../store.js";
...
export function exportCsv() {
  ...
  a.href = url;
  a.download = `skate-dryland-summary-${new Date().toISOString().slice(0, 10)}.csv`;
